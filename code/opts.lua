...
function M.parse(arg)
    ...
    cmd:option('-vgg',              0,                  'VGG loss (J. Johnson et al., ECCV 2016)')
    cmd:option('-vggDepth',         '5_4',              'VGG depth e.g. 5-4, 2-2')
    cmd:option('-adv',              0,                  'Adversarial loss (C. Ledig et al., CVPR 2017)')
    cmd:text()
